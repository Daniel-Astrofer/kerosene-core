...
### Mining (STALE — controller removed)

All Mining endpoints (`/mining/**`) and `MiningController` have been removed from the codebase. Do not implement new clients against this API.
