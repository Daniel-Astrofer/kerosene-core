...
public class QuorumPsbtSigningService {
    ...
    public OnchainFundingPreflight preflight(ExternalPaymentsCustodyPort.OnchainPreflightCommand command) {
    ...
    public OnchainExecution execute(ExternalPaymentsCustodyPort.OnchainPaymentCommand command) {
        ...
        try {
            ...
            throw new ExternalPaymentsCustodyPort.ProviderExecutionAmbiguous(
