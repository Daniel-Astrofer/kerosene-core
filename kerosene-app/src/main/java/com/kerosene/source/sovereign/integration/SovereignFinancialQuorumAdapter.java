...
@Component
public class SovereignFinancialQuorumAdapter implements FinancialQuorumPort {

    private static final Logger log = LoggerFactory.getLogger(SovereignFinancialQuorumAdapter.class);
    ...
    public SovereignFinancialQuorumAdapter(
